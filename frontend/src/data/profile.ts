...
export const profile = {
  ...
  about: '我是邱俊景，广州商学院计算机科学与技术专业 2026 届本科应届生，求职方向是 Agent 开发 / AI 应用工程。后端主用 Java/Spring Boot，前端 Vue3，数据库 MySQL 与 PostgreSQL（含 pgvector），实际落地过 Embedding、混合检索、LLM 接入与 Agent(ReAct) 编排。两个项目均从 0 独立做到可演示、可部署。',
  skills: [
  ...
  socials: [
    { name: 'GitHub', url: 'https://github.com/zeroTwo0617' }
  ]
}
